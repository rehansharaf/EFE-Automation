...
public class DetailsPage__exp2 extends TestBase {
...
*/
		...
		String  verifyDate;
		String  meetingDate;
		String  meetingformattedDate;
	    String  uid ;
	    String  unplannedDate;
...
public void set_enteredDate(String entrDate) {this.enteredDate = entrDate;}
public void set_verifyDate(String vrfyDate) {this.verifyDate = vrfyDate;}
public void set_meetingDate(String mtngDate) {this.meetingDate = mtngDate;}
public void set_meetingformattedDate(String mtngfrmtDate) {this.meetingformattedDate = mtngfrmtDate;}
public void set_unplannedDate(String unplndDate) {this.unplannedDate= unplndDate;}



public  String get_userid(){return uid;}
public  String get_enteredDate(){return enteredDate;}
public 	String get_verifyDate(){return verifyDate;}
public  String get_meetingDate(){return meetingDate;}
public  String get_meetingformattedDate(){return meetingformattedDate;}
public  String get_unplannedDate(){return unplannedDate;}
